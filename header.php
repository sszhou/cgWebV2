<!-- Code by Shiping Toohey - for Victoria University of Wellington, New Zealand. (www.computergraphics.ac.nz) -->
...
<html>
	...
	<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<meta name="description" content="Computer Graphics Programme at Victoria University of Wellington, New Zealand">
		<meta name="keywords" content="Computer Graphics, CG, Media Design">
		<meta name="author" content=">Computer Graphics, Victoria University of Wellington">
		...
		<script type="text/javascript">
          ...
          var _gaq = _gaq || [];
          _gaq.push(['_setAccount', 'UA-33366718-1']);
	...
	<div id="wrap">
		...
		<div id="headercontainer">
		    <div id="header">
		        <div id="headertext">
		            <h1><a href="index.php">Computer Graphics
		                <span>Victoria University of Wellington, New Zealand</span>
		            </a></h1>
					<h1>v·i·c· C·G</h1>
		        </div>
		    </div>
				...
				<ul>
					<li class='has-sub' id ="about_page"><a href="about.php">About</a>
						...
						<li class='has-sub '><a href='about.php#career'><span>This Qualification</span></a>
							 ...
							 <li class='has-sub '><a href="downloads.php"><span>Downloads</span></a>
							 </li>	
						</ul>
					</li>
