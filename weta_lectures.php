...
<script type="text/javascript">
     $(window).load(function() {
		...
		{
			videolink = "";//videolink = "http://player.vimeo.com/video/55993879?byline=0&amp;portrait=0&amp;color=ffffff";
		...
		{
			videolink = "";//videolink = "http://player.vimeo.com/video/61685547?byline=0&amp;portrait=0&amp;color=ffffff";
		...
		{
			videolink = "";//videolink = "http://player.vimeo.com/video/61690605?byline=0&amp;portrait=0&amp;color=ffffff" ;
		...
		function update()
		{
			if(videolink == "")
			{
				...
				$(".mainvideo .video_crop h2").text("Sorry the video is not made public yet");	
			}
			else
			{
				$(".mainvideo iframe").attr("src",videolink);
				$(".mainvideo .video_crop h2").text("");	
			}
	 ...
	 <div class="videoplaylist">
		 ...
		 <div class ="mainvideo">
			<div class ="video_crop">			
				<iframe src="http://player.vimeo.com/video/60414897?byline=0&amp;portrait=0&amp;color=ffffff" width="820" height="461" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
				<h2></h2>	
				</div>
		 ...
		 <div class ="playlist">
			...
			<div class ="single_video" id ="letteri">
				...
				<h4>Insights Into Special Effects In Rise of the Planet of the Apes</h4>
